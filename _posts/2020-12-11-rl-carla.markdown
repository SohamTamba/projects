...
* 1 lidar
* 2 radars
* GNSS, which provides the GPS location of the car
...
Video 1 illustrates the agent driving on a straight road.
...
Video 2 illustrates the agent attempting to take a right turn. It does not turn sharply enough, and hits the side-walk.
